...
for (const name of ['after-sales.ts', 'after-sales-policy.ts', 'paystack-refund.ts', 'models/Order.ts', 'models/Store.ts', 'models/WalletTransaction.ts', 'models/Product.ts']) {
