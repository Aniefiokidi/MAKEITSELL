...
export default function VendorMessagesPage() {
  ...
  const fetchConversations = async () => {
    try {
      setLoading(true)
      // Always fetch as provider for vendor dashboard
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto py-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <Card className="lg:col-span-1">
          <CardHeader>
            <CardTitle>Service Conversations</CardTitle>
            <CardDescription>Chats with your customers</CardDescription>
          </CardHeader>
            ...
            <ScrollArea className="h-[70vh]">
              {loading ? (
                ...
                <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">You have no service chats yet</p>
                </div>
              ) : (
                <div className="divide-y">
                  {conversations.map((conv) => {
                    const otherPersonName = conv.customerName
