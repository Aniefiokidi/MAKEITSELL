          ...
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground text-pretty">
                {isVendor
                  ? "Access your seller dashboard to manage products, orders, and grow your business on BRANDA marketplace."
                  : "Join thousands of successful sellers on BRANDA marketplace. Reach millions of customers with our AI-powered platform and unified customer service system."}
              </p>
        ...
        <section id="benefits" className="py-16">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-balance mb-4">Why Sell on BRANDA?</h2>
              ...
              <CardHeader>
                ...
                <CardDescription className="text-lg">
                  {isVendor
                    ...
                    : "Join BRANDA marketplace today and start reaching millions of customers"}
                </CardDescription>
              </CardHeader>
