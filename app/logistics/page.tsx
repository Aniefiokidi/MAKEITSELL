...
export default function LogisticsPage() {
  ...
  // A&CO dashboard below is kept in place (not deleted) for a clean revert if ever needed.
  return (
    <RetiredFeatureNotice
      title="Logistics dashboard retired"
      message="Deliveries are now dispatched and tracked automatically through Shipbubble. This manual A&CO dispatch dashboard is no longer in use."
    />
  )
