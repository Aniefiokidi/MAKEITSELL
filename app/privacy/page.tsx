      ...
      <main className="flex-1">
        <div className="container mx-auto px-2 sm:px-4 py-6 sm:py-10 max-w-4xl">
          ...
          <div className="mb-6 sm:mb-8 animate-fade-in-up">
            ...
            <h1 className="text-xl sm:text-2xl md:text-3xl font-extrabold mb-2 sm:mb-4 text-accent animate-fade-in-up">Privacy Policy</h1>
            <p className="text-muted-foreground text-[9px] xs:text-xs sm:text-sm animate-fade-in-up">
              Last updated: <span className="bg-accent/10 text-accent px-2 py-1 rounded shadow">{new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</span>
            </p>
          </div>

          {/* Privacy Overview */}
          <Card className="mb-6 sm:mb-8 border border-accent/10 bg-card shadow-lg animate-fade-in-up">
            <CardContent className="p-3 sm:p-6">
              <div className="flex items-start gap-2 sm:gap-4 animate-fade-in-up">
                <Shield className="w-5 h-5 sm:w-8 sm:h-8 text-accent mt-1 shrink-0" />
