...
export default function CreateDemoDataComponent() {
  ...
  if (mutation.isSuccess) {
    ...
    console.log(mutation.data.category_insertMany);
    console.log(mutation.data.product_insertMany);
    console.log(mutation.data.service_insertMany);
  }
...
export default function CreateOrderComponent() {
  ...
  // Variables can be defined inline as well.
  mutation.mutate({ productId: ..., sellerId: ..., totalAmount: ..., status: ..., orderDate: ..., });
