...
export const deleteServicesByVendor = notServerError;
export const deleteOrdersByVendor = notServerError;
export const deleteBookingsByVendor = notServerError;
export const deleteUserCartItemsByVendor = notServerError;
export const deleteConversationsByVendor = notServerError;
export const deleteUser = notServerError;
export const deleteSessions = notServerError;
